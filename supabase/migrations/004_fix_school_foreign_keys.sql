-- First update the schools table to use string IDs instead of UUIDs
ALTER TABLE public.schools ALTER COLUMN id SET DATA TYPE TEXT;

-- Also update the foreign key reference in user_school_favorites
...
-- Insert sample schools data (first 20 schools)
